	...
	<!-- Alternative Content Box Start -->
	 <div class="contentcontainer">
		...
		<div class="contentbox">
			<a class="btn bouton_add" href="<?php echo Router::url('adm/clubs/add');?>">Ajouter</a>
			<table width="100%" cellspacing="0" cellpadding="0" border="0" class="table">
				<thead>
					<tr>
						<th>#</th>
						<th>Texte de gauche</th>
						<th>Texte du centre</th>
				...
				<?php 
					...
					<tr> 
						<td><?php echo $v['id']; ?></td>
						<td><?php echo $v['txtgauche']; ?></td>
						<td><?php echo $v['txtcentre']; ?></td>
						<td><?php echo $v['txtdroite']; ?></td>
						<td><?php echo $v['content']; ?></td>
						<td><?php echo $v['online']; ?></td>
						<td>
							<a href="<?php echo Router::url('adm/clubs/edit/'.$v['id']); ?>"><img src="<?php echo BASE_URL; ?>/img/icons/icon_edit.png" alt="Edit" /></a>
						</td>
						<td>
							<a href="<?php echo Router::url('adm/clubs/delete/'.$v['id']); ?>" class="deleteBox" onclick="return confirm('Voulez vous vraiment supprimer?');"><img src="<?php  echo BASE_URL; ?>/img/icons/icon_delete.png" alt="Delete" /></a>
						</td>
		  ...
		  <?php } ?>
			...
			<!-- PAGINATION -->
			<ul class="pagination">
				<li class="text"><a  href="<?php echo Router::url('adm/clubs/index').'?page=1'; ?>">First </a></li>
				<?php for($i=1; $i<= $nbPages; $i++) { ?>
				<li class="page"><a  href="<?php echo Router::url('adm/clubs/index').'?page='.$i; ?>"><?php echo $i ; ?></a></li>
				<?php } ?>
				<li class="text"><a href="<?php echo Router::url('adm/clubs/index').'?page='.$nbPages; ?>">last</a></li>
			</ul>
