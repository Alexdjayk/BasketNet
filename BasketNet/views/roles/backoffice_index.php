	...
	<!-- Alternative Content Box Start -->
	 <div class="contentcontainer">
		...
		<div class="contentbox">
			<a class="btn bouton_add" href="<?php echo Router::url('adm/roles/add');?>">Ajouter</a>
			<table width="100%" cellspacing="0" cellpadding="0" border="0" class="table">
				<thead>
					<tr>
						<th>id</th>
						<th>Types de rôles</th>
						<th>Edit</th>
						<th>Delete</th>
				...
				<?php 
					...
					<tr> 
						...
						<td>
							<a href="<?php echo Router::url('adm/roles/edit/'.$v['id']); ?>"><img src="<?php echo BASE_URL; ?>/img/icons/icon_edit.png" alt="Edit" /></a>
						</td>
						<td>
							<a href="<?php echo Router::url('adm/roles/delete/'.$v['id']); ?>" class="deleteBox" onclick="return confirm('Voulez vous vraiment supprimer?');"><img src="<?php  echo BASE_URL; ?>/img/icons/icon_delete.png" alt="Delete" /></a>
						</td>
		  ...
		  <?php } ?>
			...
			<!-- PAGINATION -->
			<ul class="pagination">
				<li class="text"><a  href="<?php echo Router::url('adm/roles/index').'?page=1'; ?>">First </a></li>
				<?php for($i=1; $i<= $nbPages; $i++) { ?>
				<li class="page"><a  href="<?php echo Router::url('adm/roles/index').'?page='.$i; ?>"><?php echo $i ; ?></a></li>
				<?php } ?>
				<li class="text"><a href="<?php echo Router::url('adm/roles/index').'?page='.$nbPages; ?>">last</a></li>
			</ul>
