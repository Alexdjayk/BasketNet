		  ...
		  <?php } } ?>
			...
			<div class="extrabottom">
				<ul>
					...
					<li><?php echo 'Nombre de prochains matchs : '.$nbGames; ?></li>
				</ul>
			</div>
			<!-- PAGINATION -->
			<ul class="pagination">
				...
				<li class="page"><a  href="<?php echo Router::url('adm/games/index').'?page='.$i; ?>"><?php echo $i ; ?></a></li>
				<?php } ?>
				<li class="text"><a href="<?php echo Router::url('adm/games/index').'?page='.$nbPages; ?>">last</a></li>
			</ul>
